...
__all__ = [
    'SPAUDIOSTATE', 'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'DISPID_SAStatus', 'ISpeechAudio',
    'DISPID_SpeechRecoContextEvents', 'DISPID_SGRsDynamic',
    'DISPID_SpeechPhraseElements', 'SpeechStreamFileMode',
    'DISPID_SGRSTWeight', 'eLEXTYPE_APP', 'SPPS_RESERVED2',
    'SVSFUnusedFlags', 'SGRSTTRule', 'SpeechCategoryAppLexicons',
    'DISPID_SLWLangId', 'DISPID_SWFEFormatTag', 'SVP_9',
    'DISPID_SWFEExtraData', 'DISPID_SPPFirstElement',
    'IInternetSecurityMgrSite', 'DISPID_SpeechObjectTokens',
    'DISPID_SRRSaveToMemory', 'DISPID_SRRPhraseInfo',
    'DISPID_SRCEFalseRecognition', 'ISpeechXMLRecoResult',
    'SPSHORTCUTPAIR', 'SPDKL_DefaultLocation',
    'DISPID_SpeechRecognizerStatus', 'SDA_No_Trailing_Space',
    'SPEI_REQUEST_UI', 'DISPID_SPAs_NewEnum', 'STCInprocServer',
    'DISPID_SpeechObjectTokenCategory', 'ISpStreamFormat',
    'ISpProperties', 'SPPHRASEREPLACEMENT', 'DISPID_SLPSymbolic',
    'SpeechCategoryRecoProfiles', 'ISpeechPhraseReplacements',
    'SAFTADPCM_22kHzMono', 'DISPID_SPRuleNumberOfElements',
    'DISPID_SRGetRecognizers', 'DISPID_SpeechPhraseAlternates',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'IStream',
    'SPWF_SRENGINE', 'DISPID_SPPsItem', 'DISPID_SRIsUISupported',
    'SAFT11kHz16BitStereo', 'SAFT48kHz16BitStereo',
    'DISPID_SDKDeleteKey', 'SPRST_ACTIVE_ALWAYS', 'eLEXTYPE_PRIVATE2',
    'SPRULE', 'ISpeechPhraseRule', 'SAFTExtendedAudioFormat',
    'DISPID_SOTIsUISupported', 'SAFT12kHz16BitMono',
    'SPDATAKEYLOCATION', 'SPINTERFERENCE_TOOFAST', 'SpeechFormatType',
    'SpeechAllElements', 'SPEI_SOUND_END', 'ISpeechFileStream',
    'SPWORDLIST', 'IEnumString', 'DISPID_SPRulesCount',
    'SRCS_Disabled', 'DISPID_SPERequiredConfidence',
    'DISPID_SRRRecoContext', 'SpeechLexiconType', 'SSTTWildcard',
    'SpeechTokenKeyAttributes', 'DISPID_SLPsCount',
    'DISPID_SRCVoicePurgeEvent', 'DISPID_SRGIsPronounceable',
    'SP_VISEME_11', 'SpeechRecoEvents', 'SLOStatic',
    'DISPID_SVSyncronousSpeakTimeout', 'SBONone', 'WAVEFORMATEX',
    'SPXMLRESULTOPTIONS', 'DISPID_SPRuleConfidence', 'SP_VISEME_8',
    'ISpMMSysAudio', 'SpeechPropertyComplexResponseSpeed',
    'SPRST_INACTIVE_WITH_PURGE', 'SPPS_Noun',
    'SAFTCCITT_uLaw_11kHzStereo', 'DISPID_SpeechMMSysAudio',
    'eLEXTYPE_PRIVATE17', 'SAFT48kHz8BitMono', 'DISPID_SOTSetId',
    'SAFT44kHz16BitStereo', 'SPEI_MAX_SR', 'SVEEndInputStream',
    'ISpRecognizer2', 'DISPID_SVVolume', 'SECFDefault',
    'SPEI_END_SR_STREAM', 'DISPID_SGRsItem', 'SVP_8',
    'DISPID_SPRText', 'SPEI_RESERVED3', 'SPAO_RETAIN_AUDIO',
    'SAFT16kHz8BitMono', 'SECFIgnoreWidth', 'DISPID_SPPsCount',
    'SPPS_Function', 'SpMMAudioIn', 'SPINTERFERENCE_TOOSLOW',
    'SDKLDefaultLocation', '_RemotableHandle', 'SPPS_NotOverriden',
    'SPFM_OPEN_READWRITE', 'DISPID_SGRSTransitions',
    'DISPID_SOTsCount', 'DISPID_SVSInputSentencePosition',
    'SPEI_RECO_OTHER_CONTEXT', 'SPEI_RESERVED5',
    'SREPropertyNumChange', 'DISPID_SRRGetXMLResult',
    'SAFT48kHz8BitStereo', 'ISpeechObjectTokens',
    'SpInprocRecognizer', 'SpeechPropertyLowConfidenceThreshold',
    'DISPID_SWFEBlockAlign', 'DISPID_SOTCEnumerateTokens',
    'SREInterference', 'SAFTCCITT_ALaw_11kHzStereo', 'SPVPRIORITY',
    'SPPS_RESERVED3', 'ISpEventSink', 'SPEVENTENUM', 'SVSFDefault',
    'SAFTADPCM_22kHzStereo', 'SAFTCCITT_uLaw_8kHzStereo',
    'SAFT12kHz16BitStereo', 'SREAllEvents', 'DISPID_SVSLastBookmark',
    'DISPID_SVVoice', 'SP_VISEME_6', 'SRERecognition',
    'DISPIDSPTSI_SelectionOffset', 'LONG_PTR',
    'DISPID_SRCCmdMaxAlternates', 'SVSFIsXML', 'SpSharedRecoContext',
    'DISPID_SASetState', 'SDTProperty', 'DISPID_SLGetWords',
    'DISPID_SpeechLexiconWords', 'DISPID_SPRs_NewEnum',
    'ISpeechResourceLoader', 'SP_VISEME_13',
    '_ISpeechRecoContextEvents', 'DISPID_SPPChildren',
    'SAFTCCITT_uLaw_44kHzStereo', 'DISPID_SGRAttributes',
    'DISPID_SRRAlternates', 'SPEI_START_SR_STREAM',
    'SPEI_RECO_STATE_CHANGE', 'DISPID_SDKSetStringValue',
    'SpPhoneConverter', 'SPAUDIOOPTIONS', 'DISPID_SpeechFileStream',
    'SECNormalConfidence', 'SAFT22kHz16BitStereo',
    'DISPID_SVEPhoneme', 'SpeechEngineProperties',
    ...
    'SGDSInactive', 'SPAR_Low', 'STCLocalServer', 'eLEXTYPE_PRIVATE9',
    'SAFT8kHz8BitMono', 'DISPID_SpeechLexiconWord', 'SRTStandard',
    'DISPID_SRCRetainedAudioFormat', 'DISPID_SRRDiscardResultInfo',
    'DISPID_SpeechXMLRecoResult', 'SVP_7', 'DISPID_SRGId',
    'SPAUDIOBUFFERINFO', 'DISPID_SRSClsidEngine', 'SPCT_COMMAND',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'DISPID_SOTGetStorageFileName',
    'STSF_LocalAppData', 'SVSFIsFilename', 'DISPID_SRCESoundStart',
    'DISPID_SRCEAudioLevel', 'SPEI_RESERVED1', 'SPINTERFERENCE_NOISE',
    'SAFTCCITT_ALaw_22kHzMono', 'SAFT16kHz16BitMono', 'DISPID_SPPId',
    'DISPID_SRCVoice', 'SpeechVoiceCategoryTTSRate',
    'DISPID_SGRSTNextState', 'DISPID_SPCIdToPhone', 'SGSEnabled',
    'DISPID_SDKGetlongValue', 'DISPID_SLPsItem',
    'DISPID_SVAudioOutputStream', 'SREFalseRecognition', 'SGRSTTWord',
    'ISpeechRecoResult2', 'tagSTATSTG', 'tagSPPROPERTYINFO',
    'SPSMF_SRGS_SAPIPROPERTIES', 'DISPID_SGRsFindRule', 'SRSActive',
    'DISPID_SLPPartOfSpeech', 'ISpeechGrammarRuleStateTransitions',
    'SVEViseme', 'SSSPTRelativeToStart', 'ISpLexicon',
    'DISPID_SWFEBitsPerSample', 'SPEI_FALSE_RECOGNITION',
    'SREPrivate', 'SAFTCCITT_uLaw_8kHzMono',
    'ISpStreamFormatConverter', 'SpUnCompressedLexicon',
    'SAFTDefault', 'DISPID_SGRSTRule', 'SREStreamEnd',
    'SDKLCurrentConfig', 'SSFMCreate', 'eLEXTYPE_PRIVATE18',
    'DISPID_SPPName', 'SGPronounciation', 'SRSEDone',
    'ISpeechRecoResultTimes', 'DISPID_SPEEngineConfidence',
    'DISPID_SDKDeleteValue', 'SGLexical', 'Speech_Max_Word_Length',
    'DISPID_SPERetainedSizeBytes', 'eLEXTYPE_PRIVATE13',
    'SAFT44kHz16BitMono', 'DISPID_SOTGetDescription',
    'SPPS_RESERVED1', 'SVP_6', 'SPAUDIOSTATUS',
    'DISPID_SDKSetBinaryValue', 'DISPID_SPEsCount', 'SECFIgnoreCase',
    'SDA_Two_Trailing_Spaces', 'SpeechRecognitionType', 'SPAO_NONE',
    'DISPID_SAFGuid', 'DISPID_SLGetPronunciations',
    'DISPID_SpeechLexicon', 'DISPID_SRCEInterference',
    'DISPID_SASFreeBufferSpace', 'ISpRecoContext2', 'DISPID_SVStatus',
    'SVEBookmark', 'SpeechVisemeFeature', 'SPPS_Noncontent',
    'SpAudioFormat', 'DISPID_SRGetPropertyString',
    'DISPID_SRSNumberOfActiveRules', 'DISPID_SGRSTText',
    'SpeechAudioProperties', 'DISPID_SpeechMemoryStream',
    'Speech_Default_Weight', 'DISPID_SRCEEnginePrivate', 'SVP_18',
    'eLEXTYPE_RESERVED7', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'SAFTADPCM_44kHzStereo', 'SRERecoOtherContext',
    'DISPID_SVEStreamEnd', 'ISpRecoGrammar', 'SpeechRuleAttributes',
    'ISpeechMemoryStream', 'SINoSignal', 'DISPID_SpeechCustomStream',
    'SFTSREngine', 'DISPID_SPEActualConfidence', 'DISPID_SRStatus',
    'SpeechGrammarWordType', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'SPINTERFERENCE_NONE', 'ISpeechAudioStatus', 'SRARoot',
    'SECFEmulateResult', 'SPEI_SENTENCE_BOUNDARY',
    'SPRECOCONTEXTSTATUS', 'SPEI_TTS_AUDIO_LEVEL',
    'DISPID_SVESentenceBoundary', 'DISPID_SOTDataKey',
    'DISPID_SBSFormat', 'SPSInterjection', 'DISPID_SGRsCommit',
    'DISPID_SPIAudioSizeTime', 'SPEI_PROPERTY_NUM_CHANGE',
    'DISPID_SPACommit', 'SRAONone',
    'DISPID_SpeechGrammarRuleStateTransition',
    'SWPUnknownWordUnpronounceable', 'DISPID_SGRClear',
    'ISpeechPhraseInfo', 'SGRSTTTextBuffer',
    'DISPID_SpeechRecoResultTimes',
    'DISPID_SpeechGrammarRuleStateTransitions', 'DISPID_SOTCSetId',
    'DISPID_SpeechAudioFormat', 'DISPID_SRCreateRecoContext',
    'DISPID_SpeechPhraseReplacements', 'DISPID_SAEventHandle',
    'ISpNotifySource', 'SAFT11kHz8BitStereo', 'SAFT24kHz16BitStereo',
    'SVSFParseAutodetect', 'DISPID_SRGReset',
    'ISpeechRecognizerStatus', 'SPCS_DISABLED', 'SGDSActive',
    'SPVPRI_ALERT', 'DISPID_SLWType', 'DISPID_SRGDictationUnload',
    'DISPID_SRRSetTextFeedback', 'DISPID_SVEStreamStart',
    'SpeechTokenKeyFiles', 'SECHighConfidence',
    'DISPID_SPEDisplayText', 'SRESoundEnd', 'SVP_17',
    'SAFTADPCM_8kHzStereo', 'eLEXTYPE_USER', 'SP_VISEME_1',
    'SPRECORESULTTIMES', 'SAFT16kHz16BitStereo', 'STCAll',
    'DISPID_SpeechRecoContext', 'SAFT11kHz16BitMono', 'SGRSTTEpsilon',
    'SpMMAudioEnum', 'SPDKL_LocalMachine', 'SpeechCategoryAudioIn',
    'DISPID_SLAddPronunciation', 'DISPID_SVSCurrentStreamNumber',
    'DISPID_SPIEnginePrivateData', 'ISpPhrase', 'SRCS_Enabled',
    'SpeechWordType', 'DISPID_SDKEnumValues', 'DISPID_SVAudioOutput',
    'SAFTCCITT_ALaw_8kHzMono', 'SpeechWordPronounceable',
    'SPEI_PROPERTY_STRING_CHANGE', 'SpeechBookmarkOptions',
    'DISPID_SPIReplacements', 'SpeechCategoryPhoneConverters',
    'SP_VISEME_0', 'SpeechAudioFormatGUIDWave', 'SRSActiveAlways',
    'DISPID_SpeechDataKey', 'SAFTADPCM_11kHzStereo',
    'SPPS_SuppressWord', 'eLEXTYPE_PRIVATE19',
    'DISPID_SPRuleFirstElement',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'ISpeechPhraseAlternate',
    'DISPID_SRCEHypothesis', 'ISpeechPhraseElement', 'SPRS_INACTIVE',
    'SVEPrivate', 'DISPID_SVWaitUntilDone', 'SPPS_Modifier',
    'SPDKL_CurrentUser', 'DISPID_SpeechLexiconPronunciation',
    'SAFTTrueSpeech_8kHz1BitMono', 'SITooFast', 'SAFT32kHz16BitMono',
    'DISPID_SpeechRecognizer', 'ISpeechGrammarRuleState',
    'eLEXTYPE_MORPHOLOGY', 'SPEI_PHONEME', 'ISpXMLRecoResult',
    'SFTInput', 'SP_VISEME_12', 'SPEI_END_INPUT_STREAM',
    'DISPID_SPEsItem', 'DISPID_SPILanguageId', 'eLEXTYPE_RESERVED4',
    'ISpResourceManager', 'SASClosed', 'DISPID_SVSInputWordPosition',
    'DISPID_SGRAddResource', 'DISPIDSPTSI_ActiveLength',
    'eLEXTYPE_PRIVATE5', 'DISPIDSPTSI_SelectionLength',
    'SPRST_INACTIVE', 'SINoise', 'DISPID_SPEDisplayAttributes',
    'SRTAutopause', 'SVP_21', 'SP_VISEME_9', 'SPEI_INTERFERENCE',
    'DISPID_SPRuleChildren', 'STCRemoteServer', 'SP_VISEME_15',
    'ISpNotifyTranslator', 'SPADAPTATIONRELEVANCE',
    'DISPID_SGRSTPropertyValue', 'SPINTERFERENCE_TOOQUIET',
    'SpLexicon', 'DISPID_SVPriority', 'SpeechTokenContext',
    'DISPID_SVAlertBoundary', 'SPCT_SUB_DICTATION',
    'SpeechRegistryLocalMachineRoot', 'SpSharedRecognizer',
    'DISPID_SpeechAudioBufferInfo', 'ISpeechRecoContext',
    'DISPID_SOTRemoveStorageFileName', 'DISPID_SGRsCount',
    'SVSFPurgeBeforeSpeak', 'SPSModifier', 'SPAS_PAUSE',
    'DISPID_SRGSetTextSelection',
    'DISPID_SLRemovePronunciationByPhoneIds',
    'DISPID_SpeechGrammarRule', 'SPPS_Verb', 'DISPID_SABIEventBias',
    'SWTAdded', 'DISPID_SpeechRecoResult', 'SVSFParseMask',
    'SAFTCCITT_ALaw_11kHzMono', 'DISPID_SDKOpenKey',
    ...
    'SAFTADPCM_11kHzMono', 'DISPID_SRRSpeakAudio', '_SPAUDIOSTATE',
    'SDTLexicalForm', 'DISPID_SPIGrammarId',
    'DISPID_SRGetPropertyNumber', 'SPPS_Unknown', 'SBOPause',
    'eLEXTYPE_PRIVATE8', 'SPWORDPRONUNCIATIONLIST',
    'SPSEMANTICERRORINFO', 'DISPID_SMSAMMHandle', 'SVSFlagsAsync',
    'SPRST_NUM_STATES', 'SpeechTokenIdUserLexicon',
    'SAFT32kHz16BitStereo', 'SpeechVoiceSkipTypeSentence',
    'SGDSActiveWithAutoPause', 'SVP_11', 'eLEXTYPE_RESERVED8',
    'SDTPronunciation', 'UINT_PTR', 'SPEI_SR_PRIVATE',
    'DISPID_SPRuleId', 'ISpeechGrammarRules', 'SpeechAddRemoveWord',
    'DISPID_SWFEAvgBytesPerSec', 'DISPID_SLWPronunciations',
    'SpeechTokenShellFolder', 'DISPID_SVGetVoices', 'SPRECOSTATE',
    'DISPID_SRGCmdSetRuleState', 'DISPID_SpeechPhraseProperty',
    'DISPID_SOTGetAttribute', 'SAFTGSM610_11kHzMono', 'SP_VISEME_16',
    'ISpPhoneticAlphabetConverter', 'SpeechCategoryAudioOut',
    'DISPID_SRSSupportedLanguages', 'ISpObjectTokenCategory',
    'SREAudioLevel', 'SWPUnknownWordPronounceable',
    'DISPID_SPRuleEngineConfidence', 'DISPID_SPIProperties',
    'eLEXTYPE_PRIVATE16', 'SPPARTOFSPEECH',
    'DISPID_SRRTOffsetFromStart', 'SPAR_High', 'SGSExclusive',
    'DISPID_SLPPhoneIds', 'ISpeechObjectToken', 'eLEXTYPE_RESERVED10',
    'DISPID_SRSAudioStatus', 'DISPID_SpeechAudio',
    'SpTextSelectionInformation', 'SPSTREAMFORMATTYPE',
    'SVSFVoiceMask', 'SGRSTTWildcard', 'SPBOOKMARKOPTIONS',
    'SPGRAMMARWORDTYPE', 'ISpeechPhraseRules', 'DISPID_SLPLangId',
    'DISPID_SpeechVoice', 'SRTSMLTimeout', 'DISPID_SRRTimes',
    'DISPID_SABufferInfo', 'SAFT32kHz8BitMono', 'STSF_AppData',
    'ISpeechLexiconWords', 'SpeechRuleState', 'DISPID_SRRecognizer',
    'ISpeechDataKey', 'SAFTCCITT_ALaw_8kHzStereo', 'SVP_10',
    'SREBookmark', 'DISPID_SPRuleName', 'SAFTCCITT_uLaw_11kHzMono',
    'ISpeechLexiconWord', 'SpeechEngineConfidence', 'SRAImport',
    'SINone', 'SVP_16', 'SPCT_SLEEP', 'DISPID_SRAudioInput',
    'SPFILEMODE', 'SpeechEmulationCompareFlags',
    'DISPID_SRCERecognition', 'SpMemoryStream', 'SP_VISEME_19',
    'SpPhoneticAlphabetConverter', 'SP_VISEME_18',
    'DISPID_SRGetFormat', 'DISPID_SAFGetWaveFormatEx',
    'SPEI_PHRASE_START', 'SVF_None', 'SPEVENT', 'SSFMOpenReadWrite',
    'eLEXTYPE_USER_SHORTCUT', 'SpeechTokenValueCLSID',
    'eLEXTYPE_PRIVATE12', 'SPCT_SUB_COMMAND', 'SAFT24kHz8BitStereo',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SAFT24kHz16BitMono', 'DISPID_SOTsItem',
    'DISPID_SPRDisplayAttributes', 'DISPID_SRRTLength',
    'DISPID_SGRAddState', 'DISPID_SPELexicalForm', 'SREAdaptation',
    'DISPID_SLWsItem', 'DISPID_SGRsAdd', 'DISPID_SGRName',
    'DISPID_SPIStartTime', 'DISPID_SPPBRestorePhraseFromMemory',
    'SAFTCCITT_ALaw_44kHzStereo', 'SPINTERFERENCE_LATENCY_WARNING',
    'ISpeechPhraseInfoBuilder', 'SPSERIALIZEDRESULT',
    'DISPID_SABIMinNotification', 'DISPID_SAFSetWaveFormatEx',
    'SVP_13', 'DISPID_SPRNumberOfElements', 'SP_VISEME_7', 'ISpAudio',
    'SPEI_RECOGNITION', 'SpWaveFormatEx',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SPAS_STOP',
    'SECFIgnoreKanaType', 'SPEI_UNDEFINED', 'SSFMCreateForWrite',
    'DISPID_SVEViseme', 'SpVoice', 'SpObjectTokenCategory',
    'DISPID_SPEAudioTimeOffset', 'SVP_15', 'SECLowConfidence',
    'DISPID_SAFType', 'DISPID_SRGCmdLoadFromObject', 'SREPhraseStart',
    'SP_VISEME_2', 'DISPID_SVGetProfiles', 'ISpeechVoiceStatus',
    'SpCompressedLexicon', '_ISpeechVoiceEvents', 'SPCS_ENABLED',
    'SAFT32kHz8BitStereo', 'DISPID_SPEAudioSizeBytes',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SpeechGrammarTagDictation',
    'DISPID_SRGState', 'SPEI_ADAPTATION', 'DISPID_SVDisplayUI',
    'SRSInactive', 'IEnumSpObjectTokens', 'DISPID_SRCResume',
    'SPSHT_NotOverriden', 'DISPID_SPIElements', 'SPEI_VOICE_CHANGE',
    'DISPID_SVResume', 'SpeechStreamSeekPositionType',
    'SpeechMicTraining', 'DISPID_SPRsCount', 'DISPID_SPISaveToMemory',
    'SPRS_ACTIVE_USER_DELIMITED', 'DISPID_SGRSAddSpecialTransition',
    'DISPID_SRAudioInputStream', 'SpeechGrammarState',
    'ISpeechPhraseAlternates', 'DISPID_SLWsCount', 'SVSFPersistXML',
    'DISPID_SPIRule', 'DISPID_SVSPhonemeId', 'SREHypothesis',
    'SpeechRegistryUserRoot', 'DISPID_SRGDictationLoad',
    'ISpRecognizer', 'DISPID_SRGCmdLoadFromResource', 'SPPHRASERULE',
    'SPLO_STATIC', 'DISPID_SVEAudioLevel', 'SpeechRunState',
    'STSF_FlagCreate', 'DISPID_SVEVoiceChange', 'SRADefaultToActive',
    'DISPID_SVEBookmark', 'DISPID_SPCLangId', 'SAFT44kHz8BitStereo',
    'SAFTNoAssignedFormat', 'SAFTText', 'SRSInactiveWithPurge',
    'SPSHT_Unknown', 'SPPS_RESERVED4', 'DISPID_SLRemovePronunciation',
    'SpeechAudioFormatGUIDText', 'DISPIDSPTSI', 'DISPID_SGRSTsItem',
    'SRADynamic', 'ISpeechPhraseElements', 'DISPID_SRRTTickCount',
    'SpStream', 'DISPID_SOTCDefault', 'DISPID_SREmulateRecognition',
    'DISPID_SRSetPropertyNumber', 'SVP_20',
    'DISPID_SRGCmdSetRuleIdState', 'SP_VISEME_5', 'SVSFParseSsml',
    'DISPID_SRCEventInterests', 'DISPID_SOTCategory',
    'SREStreamStart', 'ISpObjectToken',
    'DISPID_SLAddPronunciationByPhoneIds', 'DISPID_SpeechVoiceEvent',
    'SVP_0', 'SWPKnownWordPronounceable', 'DISPID_SPRules_NewEnum',
    'SDTRule', 'SAFTCCITT_uLaw_22kHzStereo', 'DISPID_SOTCId',
    'SpeechAudioState', 'ISpPhraseAlt', 'SP_VISEME_14',
    'SpeechDictationTopicSpelling', 'SAFT22kHz8BitMono',
    'SPEVENTSOURCEINFO', 'DISPID_SpeechObjectToken',
    'DISPID_SRCEPropertyNumberChange', 'SPEI_WORD_BOUNDARY',
    'ISpeechRecoGrammar', 'SPCT_DICTATION', 'SVSFNLPSpeakPunc',
    'SpeechGrammarTagWildcard', 'SPRS_ACTIVE', 'DISPID_SDKCreateKey',
    'DISPID_SpeechRecoResult2', 'SPPHRASEPROPERTY', 'SDKLCurrentUser',
    'SVEAllEvents', 'SPSMF_SAPI_PROPERTIES',
    'DISPID_SRGCmdLoadFromMemory', 'SpeechTokenKeyUI',
    'SpeechVoicePriority', 'SGSDisabled', 'SRTReSent', 'SPBO_PAUSE',
    'SPAS_CLOSED', 'DISPID_SGRSRule', 'STCInprocHandler',
    'SVSFIsNotXML', 'ISpeechPhraseReplacement',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'ISpRecoCategory',
    'SPWORDPRONOUNCEABLE', 'SVP_5', 'SAFT12kHz8BitMono',
    'DISPID_SpeechPhraseElement',
    'DISPID_SRCAudioInInterferenceStatus', 'SpeechPartOfSpeech',
    'SPFM_NUM_MODES', 'SAFT44kHz8BitMono', 'DISPID_SASNonBlockingIO',
    'SP_VISEME_20', 'DISPID_SRCERequestUI', 'SVP_12',
    'SPEI_SR_AUDIO_LEVEL', 'SPEI_MIN_TTS', 'SPSEMANTICFORMAT',
    'SREStateChange', 'eLEXTYPE_VENDORLEXICON',
    'DISPID_SGRSTPropertyName', 'SVPOver', 'DISPID_SRRAudioFormat',
    'SPINTERFERENCE_NOSIGNAL', 'SVP_19', 'DISPID_SPPConfidence',
    'DISPID_SRState', 'SpeechCategoryRecognizers', 'SPBO_NONE',
    'SPAR_Medium', 'DISPID_SpeechPhraseAlternate',
    'DISPID_SWFESamplesPerSec', 'SPSVerb', 'SDTAll',
    'DISPID_SPEs_NewEnum', 'SPSNoun', 'DISPID_SRSetPropertyString',
    'SRTExtendableParse', 'SPAR_Unknown', 'ISpeechRecoResult',
    'DISPID_SVGetAudioOutputs', 'SpeechSpecialTransitionType',
    'ISpRecoResult', 'DISPID_SGRSTsCount', 'eLEXTYPE_PRIVATE20',
    'SPPS_LMA', 'SPSUnknown', 'DISPID_SPEAudioStreamOffset',
    'DISPID_SAVolume', 'SVPAlert',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet', 'SGDisplay',
    'DISPID_SpeechPhraseRules', 'SP_VISEME_4', 'SAFTADPCM_44kHzMono',
    'SpeechVoiceSpeakFlags', 'DISPID_SGRId', 'SPWORDTYPE',
    'ISpeechTextSelectionInformation', 'eLEXTYPE_PRIVATE1', 'SPSLMA',
    'DISPID_SOTs_NewEnum', 'SASPause', 'DISPID_SFSClose', 'SPSMF_UPS',
    'DISPID_SGRSTPropertyId', '__MIDL_IWinTypes_0009',
    'ISpRecognizer3', 'SSTTDictation', 'DISPID_SRGCmdLoadFromFile',
    'DISPID_SVPause', 'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'DISPID_SRCSetAdaptationData', 'DISPID_SpeechPhraseReplacement',
    'SPFM_CREATE_ALWAYS', 'DISPID_SABIBufferSize', 'SITooSlow',
    'SAFT48kHz16BitMono', 'SpeechGrammarRuleStateTransitionType',
    'SVSFNLPMask', 'SPEI_VISEME', 'DISPID_SGRsCommitAndSave',
    'SpeechDataKeyLocation', 'SpObjectToken', 'SPEI_TTS_PRIVATE',
    'SRTEmulated', 'SAFTNonStandardFormat',
    'DISPID_SpeechLexiconProns', 'DISPID_SRGRecoContext',
    'SpeechRecoContextState', 'SSSPTRelativeToEnd',
    'SPEI_ACTIVE_CATEGORY_CHANGED',
    'SpeechGrammarTagUnlimitedDictation', 'DISPID_SPRsItem',
    'SPBO_AHEAD', 'SAFTGSM610_44kHzMono', 'SRERequestUI',
    'eLEXTYPE_PRIVATE6', 'SPXRO_SML', 'SPCONTEXTSTATE',
    'ISpObjectWithToken', 'ISpeechCustomStream',
    'ISpPhoneticAlphabetSelection', 'ISpeechLexiconPronunciation',
    'eLEXTYPE_PRIVATE14', 'DISPID_SFSOpen', 'SP_VISEME_21',
    'SPPS_Interjection', 'DISPID_SpeechAudioStatus',
    'DISPID_SVSRunningState', 'SpFileStream',
    'ISpeechAudioBufferInfo', 'SPWORD', 'DISPID_SRDisplayUI',
    'SPRECOGNIZERSTATUS', 'SLODynamic', 'DISPID_SRIsShared',
    'DISPID_SRSCurrentStreamPosition', 'DISPID_SMSSetData',
    'ISpShortcut', 'DISPIDSPTSI_ActiveOffset', 'eWORDTYPE_ADDED',
    'SpeechLoadOption', 'DISPID_SASState', 'SVEPhoneme',
    'DISPID_SpeechWaveFormatEx', 'eLEXTYPE_RESERVED9',
    'DISPID_SPIGetText', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'SPGRAMMARSTATE', 'SLTUser', 'ISpeechLexiconPronunciations',
    ...
    'SPSHORTCUTPAIRLIST', 'ISpeechPhoneConverter', 'SDKLLocalMachine',
    'DISPID_SPPValue', 'SpNullPhoneConverter', 'DISPID_SLWWord',
    'tagSPTEXTSELECTIONINFO', 'DISPID_SGRInitialState',
    'SAFT22kHz16BitMono', 'DISPID_SVRate',
    'DISPID_SRGDictationSetState', 'ISpeechRecognizer',
    'Speech_StreamPos_Asap', 'DISPID_SRRGetXMLErrorInfo',
    'SRATopLevel', 'SP_VISEME_17', 'SPGS_DISABLED',
    'SAFTCCITT_uLaw_22kHzMono', 'SPEI_RESERVED2', 'SPPHRASE',
    'DISPID_SRGRules', 'SRAInterpreter', 'DISPID_SpeechVoiceStatus',
    'SPWT_PRONUNCIATION', 'SPINTERFERENCE', 'DISPID_SpeechPhraseInfo',
    'SSSPTRelativeToCurrentPosition', 'DISPID_SVEventInterests',
    'ISpStream', 'eLEXTYPE_PRIVATE15', 'SDTAudio', 'DISPID_SBSSeek',
    'SRAExport', 'SVF_Emphasis',
    'SpeechPropertyHighConfidenceThreshold',
    'DISPID_SPPNumberOfElements', 'DISPID_SVSkip',
    'DISPID_SpeechBaseStream', 'DISPID_SRCEPhraseStart', 'SPWF_INPUT',
    'ISpeechAudioFormat', 'SPBO_TIME_UNITS', 'SAFTADPCM_8kHzMono',
    'DISPID_SVSLastBookmarkId', 'DISPID_SRCState',
    'SPFM_OPEN_READONLY', 'SPVPRI_OVER', 'SAFT8kHz8BitStereo',
    'SPPHRASEELEMENT', 'DISPID_SRCRecognizer', 'DISPID_SGRs_NewEnum',
    'SpeechVisemeType', 'SDTDisplayText', 'ISpRecoGrammar2',
    'SRAORetainAudio', 'SPSNotOverriden', 'SVP_2', 'ISpRecoContext',
    'SPSHT_OTHER', 'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'SPEI_SR_BOOKMARK', 'SP_VISEME_3', 'SPINTERFERENCE_TOOLOUD',
    'DISPID_SCSBaseStream', 'SPWT_DISPLAY', 'DISPID_SMSGetData',
    'SPEI_TTS_BOOKMARK', 'DISPID_SVSpeak',
    'DISPID_SRCRequestedUIType', 'DISPID_SpeechGrammarRuleState',
    'SAFT8kHz16BitMono', 'SRESoundStart', 'DISPID_SPRulesItem',
    'DISPID_SRCERecognizerStateChange', 'ISpGrammarBuilder',
    'SPLOADOPTIONS', 'SVEVoiceChange', 'SAFT22kHz8BitStereo',
    'SPTEXTSELECTIONINFO', 'SPFM_CREATE', 'SLTApp',
    'DISPID_SOTDisplayUI', 'DISPID_SLGenerationId',
    'DISPID_SLPs_NewEnum', 'eLEXTYPE_RESERVED6',
    'DISPID_SPANumberOfElementsInResult', 'ISpeechWaveFormatEx',
    'SRSEIsSpeaking', 'SpeechPropertyResourceUsage', 'SVP_1',
    'DISPID_SASCurrentSeekPosition', 'SPGS_ENABLED',
    'SPSERIALIZEDPHRASE', 'SAFTGSM610_22kHzMono', 'ISpeechBaseStream',
    'SpeechAudioFormatType', 'DISPID_SOTCGetDataKey',
    'eLEXTYPE_PRIVATE3', 'SpeechVoiceEvents', 'ISpPhoneConverter',
    'DISPID_SRProfile', 'DISPID_SLGetGenerationChange',
    'IInternetSecurityManager', 'DISPID_SRCEAdaptation',
    'SPSHT_EMAIL', 'eLEXTYPE_PRIVATE4', 'DISPID_SPEAudioSizeTime',
    'eLEXTYPE_PRIVATE7', 'DISPID_SGRSAddWordTransition',
    'ISpSerializeState', 'SVEStartInputStream',
    'SpeechDisplayAttributes', 'SpeechRetainedAudioOptions',
    'SAFT12kHz8BitStereo', 'SPVOICESTATUS',
    'DISPID_SRCEPropertyStringChange',
    'DISPID_SASCurrentDevicePosition', 'SpeechCategoryVoices',
    'SPEI_MAX_TTS', 'SpeechRecognizerState', 'DISPID_SRGCommit',
    'DISPID_SPERetainedStreamOffset', 'DISPID_SpeechPhraseProperties',
    'DISPID_SpeechPhraseRule', 'SPWAVEFORMATTYPE',
    'eLEXTYPE_LETTERTOSOUND', 'SVSFParseSapi', 'SPWORDPRONUNCIATION',
    'ISequentialStream', 'SWTDeleted', 'DISPID_SADefaultFormat',
    'DISPID_SVSLastStreamNumberQueued', 'SPSSuppressWord',
    'DISPID_SPPParent', 'Speech_Max_Pron_Length',
    'DISPID_SpeechPhraseBuilder', 'ISpeechPhraseProperties',
    'DISPID_SPIRetainedSizeBytes', 'SpStreamFormatConverter',
    'SpResourceManager', 'DISPID_SVSVisemeId',
    'DISPID_SPAStartElementInResult', 'SDTAlternates',
    'SECFNoSpecialChars', 'SPLO_DYNAMIC',
    'SpeechPropertyResponseSpeed', 'SITooLoud', 'ISpeechVoice',
    'DISPID_SDKGetBinaryValue', 'SPPROPERTYINFO', 'SPGS_EXCLUSIVE',
    'SAFTCCITT_uLaw_44kHzMono', 'DISPID_SVSLastResult',
    'DISPID_SWFEChannels', 'DISPID_SGRSTs_NewEnum',
    'DISPID_SMSADeviceId', 'DISPID_SMSALineId', 'SpCustomStream',
    'SPEI_SR_RETAINEDAUDIO', 'SpeechPropertyAdaptationOn',
    'ISpNotifySink', 'DISPID_SDKSetLongValue',
    'SGDSActiveUserDelimited', 'DISPID_SPIEngineId',
    'DISPID_SVGetAudioInputs', 'SAFT8kHz16BitStereo',
    'SGRSTTDictation', 'SPVPRI_NORMAL', 'DISPID_SOTCreateInstance',
    'DISPID_SVEWord', 'SGLexicalNoSpecialChars', 'SVPNormal',
    'SPEI_MIN_SR', 'SAFTCCITT_ALaw_44kHzMono', 'SAFTGSM610_8kHzMono',
    'SPWT_LEXICAL', 'SDA_One_Trailing_Space',
    'SPEI_START_INPUT_STREAM', 'DISPID_SpeechPhoneConverter',
    'SPVISEMES', 'DISPID_SBSWrite', 'DISPID_SVSpeakCompleteEvent',
    'SVF_Stressed', 'DISPID_SDKGetStringValue', 'DISPID_SPAsCount',
    'DISPID_SPAsItem', 'eLEXTYPE_PRIVATE11', 'SSFMOpenForRead',
    'STSF_CommonAppData', 'SVP_3', 'SAFT16kHz8BitStereo',
    'SpeechAudioVolume', 'SASRun', 'DISPID_SDKEnumKeys',
    'DISPID_SOTId', 'DISPID_SBSRead', 'SPRULESTATE',
    'DISPID_SRCEBookmark', 'DISPID_SLWs_NewEnum',
    'SPXRO_Alternates_SML', 'SDA_Consume_Leading_Spaces',
    'SpeechInterference', 'DISPID_SOTMatchesAttributes',
    'SPCATEGORYTYPE', 'SpInProcRecoContext',
    'DISPID_SRSCurrentStreamNumber', 'ISpDataKey', 'SVP_4',
    'SAFTCCITT_ALaw_22kHzStereo', 'SPSFunction',
    'DISPID_SVIsUISupported', 'SPEI_SOUND_START', 'SSTTTextBuffer',
    'DISPID_SPRFirstElement', 'DISPID_SPPEngineConfidence',
    'SVEWordBoundary', 'SPEI_HYPOTHESIS', 'SVP_14',
    'ISpeechRecoResultDispatch', 'DISPID_SPPs_NewEnum',
    'DISPID_SPEPronunciation', 'DISPID_SRCBookmark',
    'SPDKL_CurrentConfig', 'DISPID_SPAPhraseInfo',
    'DISPID_SPCPhoneToId', 'SpeechDiscardType', 'SpPhraseInfoBuilder',
    'DISPID_SRCPause', 'SpeechUserTraining', 'SpMMAudioOut',
    'SPAS_RUN', 'DISPID_SVEEnginePrivate', 'DISPID_SLPType',
    'SPBINARYGRAMMAR', 'SPEI_RESERVED6', 'DISPID_SGRSTType',
    'SpeechRecoProfileProperties', 'DISPID_SPIGetDisplayAttributes',
    'DISPID_SRCEStartStream', 'SITooQuiet', 'eWORDTYPE_DELETED',
    'ISpeechGrammarRuleStateTransition', 'ISpVoice',
    'SAFT11kHz8BitMono', 'SPSHORTCUTTYPE',
    'DISPID_SVSInputWordLength', 'SVESentenceBoundary', 'SASStop',
    'SPRST_ACTIVE', 'DISPID_SABufferNotifySize', 'eLEXTYPE_PRIVATE10',
    'DISPID_SRRTStreamTime', 'SPLEXICONTYPE', 'SVEAudioLevel',
    'ISpeechObjectTokenCategory', 'DISPID_SRCRetainedAudio',
    'DISPID_SRCCreateGrammar', 'DISPIDSPRG', 'ISpeechMMSysAudio',
    'SAFT24kHz8BitMono', 'DISPID_SPARecoResult', 'ISpeechLexicon',
    'SpShortcut', 'SP_VISEME_10', 'DISPID_SRCESoundEnd',
    'DISPID_SPRuleParent', 'ISpEventSource', 'SpNotifyTranslator',
    'DISPID_SpeechGrammarRules', 'ISpeechGrammarRule'
]

_check_version('1.2.0', 1700041830.557206)
